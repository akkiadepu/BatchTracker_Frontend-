...
//         const locationResponse = await axios.get('http://localhost:8080/locations');
...
//     if (editBatchId) {
//       try {
//         const response = await axios.put(`http://localhost:8080/batches/${editBatchId}`, {
//           id: formData.id,
//           name: formData.name,
...
//           batch.id === editBatchId ? response.data : batch
//         ));
...
//     try {
//       await axios.delete(`http://localhost:8080/batches/${id}`);
...
//               <select value={batchFilter} onChange={handleBatchFilterChange}>
...
//                     <button type="button" onClick={() => setEditBatchId(null)}>Cancel</button>
//                   </td>
//                 </>
//               ) : (
//                 <>
